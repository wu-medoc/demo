  ...
  @Component({
    ...
    template: `
     <div class="parent p-4">
      ...
      <button (click)="updateCounter()" class="btn btn-sm btn-outline-dark">Update counter</button>
      <button (click)="reset()" class="btn btn-sm btn-outline-dark">Reset Counter</button>
